...
import nagoya.kuu.miolife.iijmio.remote.couponinfo.response.CouponInfoResponse
import nagoya.kuu.miolife.iijmio.remote.couponinfo.response.convert
...
class APIServiceImpl(
    ...
    override suspend fun getCouponRemainData(): CouponRemainStatus {
        ...
        try {
            ...
            return CouponRemainStatus.Success(
                result.parse(CouponInfoResponse.serializer()).convert()
            )
